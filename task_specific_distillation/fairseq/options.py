...
def add_crd_args(parser):
    ...
    group.add_argument('--init_pretrained', type=str, help='give pretrained state dict for model initialization')
    # fmt: on
    return group

def add_test_args(parser):
    group = parser.add_argument_group("Test")
    group.add_argument('--feature_loss_type', type=str, help='method to compute the feature loss')
    group.add_argument('--feature_proj_type', type=str, help='method to project the feature')
    group.add_argument('--pred_distill', action='store_true', help='prediction layer distillation stage')
    group.add_argument('--all_in_one', action='store_true', help='train two stages together')
    group.add_argument('--feature_learn', type=str, help='method to learn the intermediate layer of teacher model')
    group.add_argument('--kl_weight', type=float, default=0.5, help='loss weight of the attention kl divergence loss')
    group.add_argument('--inter_weight', type=float, default=1, help='loss weight of the intermediate layers')
    group.add_argument('--run-name', type=str, default=None, help='clearML experiment run name')
    group.add_argument('--project-name', type=str, default=None, help='clearML project name')
    group.add_argument('--experiment-group', type=str, default=None, help='clearML experiment name')
    # group.add_argument('--feature_learn_to_continue', type=str, default=None)
    group.add_argument('--two_stage_learn', type=int, default=None)
    group.add_argument('--aug', type=bool, default=False, help='augmentation')
    group.add_argument('--layer_selection', type=str,
        default='1,3,5,7,9,11',
        help= "the layer of teacher model to learn from"
    )
    group.add_argument('--mapping', type = str, default='skip')
